...
python3.7 -m paddle.distributed.launch --gpus="0,1,2,3,4,5,6,7" tools/eval.py -c ppcls/configs/ImageNet/EfficientNetV2/EfficientNetV2_S.yaml \
-o Global.pretrained_model="output/EfficientNetV2_S/best_model.ema"
